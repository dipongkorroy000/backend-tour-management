...
const getInvoiceDownloadUrl = async (paymentId: string) => {
  ...
  if (!payment.invoiceUrl) throw new AppError(401, "No invoice found");

  return payment.invoiceUrl;
};

export const PaymentService = { successPayment, failPayment, cancelPayment, initPayment, getInvoiceDownloadUrl };
